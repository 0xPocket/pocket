    ...
    <MainWrapper>
      <div className="container-classic container mx-auto flex flex-col gap-4 rounded-xl p-8">
        ...
        <p>
          ...
          <a href="https://gopocket.fr">gopocket.fr</a> website
          ...
          &#8220;you&#8221; or &#8220;your&#8221;) and Pocket SAS (doing
          business as &#8220;pocket&#8221;, &#8220;we&#8221;, &#8220;us&#8221;
          or &#8220;our&#8221;). If you are entering into this agreement on
          ...
          a contract between you and pocket, even though it is electronic and is
        ...
        <p>
          ...
          against pocket with respect to such other services. Pocket is not
          ...
          expressly permitting pocket to disclose your data as necessary to
        ...
        <p>
          ...
          purchase an item, pocket will receive an affiliate commission. We are
        ...
        <h2 id="important-notice-regarding-digital-assets">
          IMPORTANT NOTICE REGARDING DIGITAL ASSETS
        </h2>
        <p>
          AS WITH ANY ASSET, THE VALUE OF DIGITAL ASSETS CAN GO UP OR DOWN AND
          THERE CAN BE SUBSTANTIAL RISK THAT YOU LOSE MONEY BUYING, SELLING,
          TRADING, HOLDING OR INVESTING IN DIGITAL ASSETS SUCH AS CRYPTO
          CURRENCIES. YOU SHOULD CAREFULLY CONSIDER WHETHER BUYING, SELLING,
          HOLDING, TRADING OR BUYING DIGITAL ASSETS IS SUITABLE FOR YOU. The
          value of Digital Assets may be derived from the continued willingness
          of market participants to exchange Digital Assets for Fiat currencies
          or other Digital Assets. If such willingness is abolished for any
          reason, this may result in the potential for a permanent and total
          loss of value of a particular Digital Asset. The volatility and
          unpredictability of the price of Digital Assets may result in
          significant loss over a short period of time.
        </p>
        <p>
          THE TREATMENT OF DIGITAL ASSETS VARIES BY JURISDICTION. BE ADVISED
          THAT IN SOME JURISDICTIONS, DUE TO REGULATORY CONCERNS, POCKET MAY NOT
          PROVIDE PART OR ALL OF THE SERVICES. The Services are not available
          where prohibited by law or by Pocket policy, as updated from time to
          time; currently, such places include, but are not necessarily limited
          to, the countries of Iran, North Korea, Sudan, South Sudan, Syria,
          Cuba, Russia, or any other country against which the United States,
          the United Kingdom or the European Union imposes financial sanctions
          or embargoes. Pursuant to the economic sanctions programs administered
          in the countries where we conduct business our policies are designed
          to comply with these sanctions programs and we may: (i) suspend the
          Service; (ii) terminate the Service; (iii) restrict your Service; (iv)
          return Digital Assets to the destination of their origin or to an a
          location specified by authorities; or (v) block the transfer of
          Digital Assets that are the property of a sanctioned person.
        </p>
        <h2 id="important-information">IMPORTANT INFORMATION</h2>
        <p>
          PLEASE CAREFULLY REVIEW THESE TERMS PRIOR TO ACCESSING AND USING THE
          POCKET APPLICATION. THE TERMS INCLUDE IMPORTANT INFORMATION ABOUT YOUR
          RELATIONSHIP TO POCKET. YOUR USE OF THE POCKET APPLICATION IS
          EXPRESSLY CONDITIONED ON YOUR CONSENT TO, AND COMPLIANCE WITH, THE
          TERMS. BY ACCESSING OR USING THE SERVICE, YOU AGREE TO BE BOUND BY
          THESE TERMS. IF YOU DO NOT AGREE TO ANY OF THE PROVISIONS OF THESE
          TERMS YOU SHOULD IMMEDIATELY STOP USING THE SERVICE. FAILURE TO COMPLY
          WITH THIS DIRECTIVE MAY RESULT IN A VIOLATION OF THE APPLICABLE LAWS
          OR REGULATIONS OF YOUR JURISDICTION. WHEN IN DOUBT, PLEASE CONTACT US
          AT: HELLO@GOPOCKET.FR.
        </p>
        ...
        <p>
          ...
          pocket, its affiliates, directors, officers, employees, agents,
          ...
          aggregate liability of pocket and its affiliates, officers, employees,
          ...
          actually paid in cash by you to pocket for the prior one month period
        ...
        <p>
          You agree to indemnify and hold pocket and its affiliates, directors,
        ...
        <p>
          ...
          and procedural laws of France without regard to its rules on conflicts
          or choice of law and, to the extent applicable, the laws of France.
          The exclusive jurisdiction and venue for actions related to the
          subject matter hereof shall be the courts located in France, and you
        ...
        <p>
          ...
          will send you an email to notify you. We may also provide notice to
        ...
        <p>
          <a href="&#109;&#097;&#105;&#108;&#116;&#111;&#058;&#104;el&#108;&#111;&#64;&#103;&#111;p&#111;&#99;&#107;et&#46;&#102;&#114;">
            h&#101;llo&#64;g&#111;p&#111;cke&#116;&#46;&#102;r
          </a>
        </p>
