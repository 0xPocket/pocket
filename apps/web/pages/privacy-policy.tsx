    ...
    <MainWrapper noTermsModal>
      <div className="container-classic container mx-auto flex flex-col gap-4 rounded-xl p-8">
        ...
        <p>
          ...
          Pocket SAS (doing business as &#8220;Pocket&#8221;, &#8220;we&#8221;,
        ...
        <p>
          ...
          platforms and our joint partners. Personal Information we collect from
          ...
          city and state, and online behavioral data, such as information about
          your use of social media websites, page view information and search
          results and links.
        </p>
        <p>
        ...
        <p>
          ...
          <Link href="https://www.internetcookies.com">
            <a target="_blank">internetcookies.com</a>
          </Link>
        </p>
        ...
        <p>
          <Link href="https://app.websitepolicies.com/dsar/view/xp6pswx9">
            <a target="_blank" rel="nofollow noreferrer noopener external">
        ...
        <p>This document was last updated on September 13, 2022</p>
